...
func runVerify(opts *Options) error {
	...
	// Verify extensions
	if err := verification.VerifyCertExtensions(results, opts.Tenant, opts.Owner, opts.Repo, opts.OIDCIssuer); err != nil {
		opts.Logger.Println(opts.Logger.ColorScheme.Red("✗ Verification failed"))
		return err
	}
	...
	if opts.exporter != nil {
		...
		if err = opts.exporter.Write(opts.Logger.IO, results); err != nil {
	...
	tableContent, err := buildTableVerifyContent(opts.Tenant, results)
	if err != nil {
